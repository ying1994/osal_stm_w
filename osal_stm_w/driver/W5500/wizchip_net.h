...
#define WIZCHIP_NET_CH0		0
#define WIZCHIP_NET_CH1		1
#define WIZCHIP_NET_CH2		2
#define WIZCHIP_NET_CH3		3
#if _WIZCHIP_ > 5100
#define WIZCHIP_NET_CH4		4
#define WIZCHIP_NET_CH5		5
#define WIZCHIP_NET_CH6		6
#define WIZCHIP_NET_CH7		7
#endif  
#define WIZCHIP_NET_SIZE	_WIZCHIP_SOCK_NUM_
