...
//! CS
#define HT1621B_CS_ON	HalGpioWrite(HT1621B_CS_GPIO_TYPE, HT1621B_CS_GPIO_PIN, 1)
#define HT1621B_CS_OFF	HalGpioWrite(HT1621B_CS_GPIO_TYPE, HT1621B_CS_GPIO_PIN, 0)

//! RD
#define HT1621B_RD_ON	HalGpioWrite(HT1621B_RD_GPIO_TYPE, HT1621B_RD_GPIO_PIN, 1)
#define HT1621B_RD_OFF	HalGpioWrite(HT1621B_RD_GPIO_TYPE, HT1621B_RD_GPIO_PIN, 0)

//! WR
#define HT1621B_WR_ON	HalGpioWrite(HT1621B_WR_GPIO_TYPE, HT1621B_WR_GPIO_PIN, 1)
#define HT1621B_WR_OFF	HalGpioWrite(HT1621B_WR_GPIO_TYPE, HT1621B_WR_GPIO_PIN, 0)

//! DATA
#define HT1621B_DATA_ON		HalGpioWrite(HT1621B_DATA_GPIO_TYPE, HT1621B_DATA_GPIO_PIN, 1)
#define HT1621B_DATA_OFF	HalGpioWrite(HT1621B_DATA_GPIO_TYPE, HT1621B_DATA_GPIO_PIN, 0)
